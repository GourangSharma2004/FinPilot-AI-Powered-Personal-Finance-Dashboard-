                                    ...
                                    <Col lg={9}>
                                        <div>
                                            <div className="text-center">
                                                ...
                                                <p className="text-muted">Get your free finpilot account now.</p>
                                            </div>
                                            ...
                                            <div className="p-2 mt-5">
                                                <form onSubmit={handleSubmit(onSubmit)} className="form-horizontal">
                                                    ...
                                                    <div className="mt-4 text-center">
                                                        <p className="mb-0">By registering you agree to the finpilot <Link to="#" className="text-primary">Terms of Use</Link></p>
                                                    </div>
                                                </form>
                                            </div>
                                            ...
                                            <div className="mt-5 text-center">
                                                ...
                                                <p>© 2021 finpilot. Crafted with <i className="mdi mdi-heart text-danger"></i> by Themesdesign</p>
                                            </div>
                                        </div>
                                    </Col>
                                </Row>
